...
-- ---------------------------------------------------------------------------
-- Kapitalkonto bearbeitbar/löschbar: nur Einzahlungen (keine Zuweisungen,
-- die bleiben nur stornierbar). Beide Funktionen lehnen die Änderung ab,
-- wenn der Kapitalbestand dadurch ins Minus rutschen würde.
-- ---------------------------------------------------------------------------
