...
const es: Dictionary = {
  ...
  home: {
    ...
    subtitle: "Elige un área para empezar.",
    dashboardTitle: "Dashboard",
    dashboardDesc: "Ingresos, gastos fijos y bolsillos de ahorro de un vistazo.",
    fixedCostsTitle: "Gastos fijos",
    fixedCostsDesc: "Gestiona tus categorías de gastos fijos mensuales.",
    pocketsTitle: "Planes de ahorro",
    pocketsDesc: "Gestiona tus bolsillos de ahorro y tasas mensuales.",
    capitalTitle: "Capital",
    capitalDesc: "Gestiona tu capital existente y asígnalo a bolsillos de ahorro.",
    tipsTitle: "Consejos de ahorro",
    tipsDesc: "Fundamentos prácticos para empezar a ahorrar.",
  },
  dashboard: {
    title: "Dashboard",
