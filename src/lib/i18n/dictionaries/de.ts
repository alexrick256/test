...
const de: Dictionary = {
  ...
  home: {
    ...
    subtitle: "Wähle einen Bereich, um loszulegen.",
    dashboardTitle: "Dashboard",
    dashboardDesc: "Einnahmen, Fixkosten und Sparpockets im Überblick.",
    fixedCostsTitle: "Fixkosten",
    fixedCostsDesc: "Deine monatlichen Fixkosten-Kategorien verwalten.",
    pocketsTitle: "Sparpläne",
    pocketsDesc: "Deine Sparpockets und Sparraten verwalten.",
    capitalTitle: "Kapital",
    capitalDesc: "Dein vorhandenes Kapital verwalten und Sparpockets zuweisen.",
    tipsTitle: "Spartipps",
    tipsDesc: "Praxisnahe Grundlagen rund ums Sparen.",
  },
  dashboard: {
    title: "Dashboard",
