...
const en: Dictionary = {
  ...
  home: {
    title: "Welcome back",
    subtitle: "Pick an area to get started.",
    dashboardTitle: "Dashboard",
    dashboardDesc: "Income, fixed costs, and savings pockets at a glance.",
    fixedCostsTitle: "Fixed costs",
    fixedCostsDesc: "Manage your monthly fixed-cost categories.",
    pocketsTitle: "Savings plans",
    pocketsDesc: "Manage your savings pockets and monthly rates.",
    capitalTitle: "Capital",
    capitalDesc: "Manage your existing capital and allocate it to savings pockets.",
    tipsTitle: "Savings tips",
    tipsDesc: "Practical basics for getting started with saving.",
  },
  dashboard: {
    title: "Dashboard",
  ...
  grid: {
    ...
    onboardingTip:
      "Tip: Enter your savings goal and target date in the savings calculator below – it instantly shows how much to set aside each month, and whether that's feasible with your \"left to spend\".",
  ...
  capital: {
    ...
    emptyStateHint: "No capital recorded yet. Enter your existing savings below to get started.",
    ...
    reverseConfirm: "Really reverse this entry? An offsetting entry will be created.",
